...
class AtencionSaludModel extends AtencionSaludEntity {
  const AtencionSaludModel(
      {super.atencionSaludId,
      super.afiliadoId,
      super.familiaId,
      super.enfermedadAcudeId,
      super.recibioAtencionMedTradicionalId,
      super.enfermedadTratamientoId,
      super.utilizaPlantasMedId,
      super.lugarPlantaMedicinalId,
      super.lstEnfermedadesTradicionales,
      super.lstEspecialidadesMedTradicional,
      super.lstLugaresAtencionMedico,
      super.lstPlantasMedicinales});

  factory AtencionSaludModel.fromEntity(AtencionSaludEntity atencionSalud) {
