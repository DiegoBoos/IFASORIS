...
class DimensionSocioCulturalPueblosIndigenasModel
  ...
  const DimensionSocioCulturalPueblosIndigenasModel({
    super.dimSocioCulturalPueblosIndigenasId,
    super.afiliadoId,
    super.familiaId,
    super.religionProfesaId,
    super.conoceUsosCostumbresId,
    super.cualesUsosCostumbres,
    super.participaCostumbresId,
    super.costumbrePracticaId,
    super.sancionJusticiaId,
    super.sitiosSagradosId,
    super.cualesSitiosSagrados,
    super.lstEventoCostumbreParticipa,
  });

  factory DimensionSocioCulturalPueblosIndigenasModel.fromEntity(
