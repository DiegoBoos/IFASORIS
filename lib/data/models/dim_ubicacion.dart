...
class DimUbicacionModel extends DimUbicacionEntity {
  const DimUbicacionModel({
    ...
    super.afiliadoId,
    super.familiaId,
    super.nombreRecibeVisita,
    super.tipoDocRecibeVisita,
    super.documentoRecibeVisita,
    super.perteneceResguardo,
    super.viaAccesoId,
    super.resguardoId,
    ...
    super.existeMedTradicionalComunidad,
    super.tiempoTardaMedTradId,
    super.costoDesplazamientoMedTradicional,
    super.poseeChagra,
    super.produccionMinera,
    super.tipoCalendarioId,
    super.lstDificultadAccesoMedTradicional,
    super.lstCereales,
    super.lstDificultadAccesoAtencion,
    super.lstEspMedTradicional,
    super.lstAnimalCria,
    super.lstFrutos,
    super.lstHortalizas,
    super.lstLeguminosas,
    super.lstMediosComunica,
    super.lstMediosUtilizaCA,
    super.lstMediosMedTradicional,
    super.lstNombreMedTradicional,
    super.lstTuberculos,
    super.lstVerduras,
  });

  factory DimUbicacionModel.fromEntity(DimUbicacionEntity entity) {
