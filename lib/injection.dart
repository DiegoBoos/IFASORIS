...
void afiliadoInit() {
  // bloc
  locator.registerFactory(() => AfiliadosBloc(
      afiliadoUsecaseDB: locator(),
      afiliadoPrefsBloc: locator(),
      familiaCubit: locator(),
      fichaCubit: locator()));

  // cubit

  locator.registerFactory(() => AfiliadoCubit(afiliadoUsecaseDB: locator()));
...
void grupoFamiliarInit() {
  ...
  locator.registerFactory(() => GrupoFamiliarBloc(
      grupoFamiliarUsecaseDB: locator(), afiliadoUsecaseDB: locator()));
