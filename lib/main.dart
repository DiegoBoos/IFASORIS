...
import 'ui/blocs/afiliados/afiliados_bloc.dart';
...
import 'ui/cubits/afiliado/afiliado_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
            create: (_) => di.locator<AfiliadosBloc>(),
          ),
          BlocProvider(
          ...
          BlocProvider(
            create: (_) => di.locator<AfiliadoCubit>(),
          ),
        ],
        child: MaterialApp(
            title: 'IFASORIS',
