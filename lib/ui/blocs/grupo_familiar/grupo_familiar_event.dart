...
class CheckFichaAfiliado extends GrupoFamiliarEvent {
  final AfiliadoEntity afiliado;

  const CheckFichaAfiliado(this.afiliado);
}
...
class CompleteGrupoFamiliar extends GrupoFamiliarEvent {
  final int afiliadoId;

  const CompleteGrupoFamiliar(this.afiliadoId);
}

class ErrorGrupoFamiliar extends GrupoFamiliarEvent {
  final String message;

  const ErrorGrupoFamiliar(this.message);
}
