...
class ConnectionSQLiteService {
  ...
  static FutureOr<void> _onCreate(Database db, int version) {
    db.transaction((ref) async {
      ...
      ref.execute(ConnectionSQL.CREATE_CURSO_VIDA_GRUPO_FAMILIAR);
      ...
      ref.execute(ConnectionSQL.CREATE_GRUPO_RIESGO_GRUPO_FAMILIAR);
      ...
      ref.execute(ConnectionSQL.CREATE_LENGUA_MANEJA_GRUPO_FAMILIAR);
      ...
      ref.execute(ConnectionSQL.CREATE_NIVEL_EDUCATIVO_GRUPO_FAMILIAR);
      ref.execute(ConnectionSQL.CREATE_NOMBRE_LENGUA_MATERNA_GRUPO_FAMILIAR);
      ref.execute(ConnectionSQL.CREATE_NOMBRES_ENFERMEDAD);
      ref.execute(ConnectionSQL.CREATE_NUMERO_CIGARRILLOS_DIA);
      ref.execute(ConnectionSQL.CREATE_OCUPACION_GRUPO_FAMILIAR);
      ...
      ref.execute(ConnectionSQL.CREATE_PUEBLOS_INDIGENAS_GRUPO_FAMILIAR);
